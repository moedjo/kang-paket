...
class MediaLibrary
{
    ...
    {
        $this->storageFolder = self::validatePath(Config::get('system.storage.media.folder', 'media'), true);
        $this->storagePath = rtrim(Config::get('system.storage.media.path', '/storage/app/media'), '/');
